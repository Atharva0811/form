      ...
      <div className="bg-white w-full max-w-5xl rounded-3xl py-8 flex flex-col space-y-8 shadow border border-slate-200">
        <div className="px-4 md:px-8 py-2 flex">
          <input
            ...
            className="mx-auto text-center font-bold ext-2xl md:text-3xl placeholder-slate-800 focus:placeholder-slate-300 focus:outline-none focus:border-b border-slate-300 p-2"
          />
        </div>
      </div>
